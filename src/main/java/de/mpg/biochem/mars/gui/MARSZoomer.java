 ...
 * </p>
 */
public class MARSZoomer extends XYChartPlugin<Number, Number> {
    ...
    public static final Predicate<MouseEvent> ZOOM_IN_MOUSE_FILTER = event -> MouseEvents
    		.isOnlyPrimaryButtonDown(event);// && MouseEvents.modifierKeysUp(event);
    ...
    private Predicate<MouseEvent> zoomInMouseFilter = ZOOM_IN_MOUSE_FILTER;
     ...
     */
    public MARSZoomer(AxisMode zoomMode) {
        this(zoomMode, false);
    }
     ...
     */
    public MARSZoomer(boolean animated) {
     ...
     * @param animated initial value of {@link #animatedProperty() animated} property
     */
    public MARSZoomer(AxisMode zoomMode, boolean animated) {
